            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:flex items-center space-x-4">
                ...
                <Link
                  ...
                  className="text-slate-700 dark:text-white hover:text-purple-600 dark:hover:text-purple-400 px-3 py-2 rounded-md text-sm font-medium flex items-center"
                >
                  <MessageSquare className="h-4 w-4 mr-1 text-cyan-500" />
                  Chat
                </Link>
              ...
              <div className="md:hidden flex items-center">
                ...
                <button onClick={toggleMenu} className="text-slate-700 dark:text-white hover:text-purple-600 dark:hover:text-purple-400 focus:outline-none">
          ...
          {isOpen && (
            <div className="md:hidden bg-white dark:bg-slate-900 shadow-lg">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                {/* Data Structures Section - Mobile */}
                <div className="text-slate-700 dark:text-white px-3 py-2 font-medium">
                  <div className="flex items-center mb-2">
                ...
                {/* Add Chat Link Mobile */}
                <Link
                  to="/chat"
                  className="text-slate-700 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800 block px-3 py-2 rounded-md text-base font-medium flex items-center"
                  onClick={() => setIsOpen(false)}
                >
